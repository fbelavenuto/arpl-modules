...
#define DRV_MODULE_EXTRA_VER	""
#define DRV_MODULE_VERSION	"1.8.54" DRV_MODULE_EXTRA_VER

#define DRV_VER_MAJ	1
#define DRV_VER_MIN	8
#define DRV_VER_UPD	54
...
#define BNXT_CHIP_NUM_588XX(chip_num)		\
	...
	#define BNXT_FLAG_CHIP_SR	0x2000000
...
#define BNXT_CHIP_SR(bp)	((bp)->flags & BNXT_FLAG_CHIP_SR)
#define BNXT_POLL_VF(bp)	(BNXT_CHIP_SR(bp) && BNXT_VF(bp))
...
#define BNXT_CHIP_P4_PLUS(bp)			\
	...
	void			*reserved;	/* Old bnxt_re sees that the
						 ...
						 */
	u32			ulp_version;	/* New bnxt_re checks that
						 * the ulp_version is correct
						 * before calling the new
						 * ulp_probe.
						 */
#define BNXT_ULP_VERSION 0x695a0001	/* Change this when any interface
					 * structure or API changes between
					 * bnxt_en and bnxt_re.
					 */
